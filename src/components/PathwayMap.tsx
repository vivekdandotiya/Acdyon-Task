              ...
              {nodes.map((node, idx) => {
                ...
                return (
                  ...
                  >
                    {/* Node Badge Box */}
                    <div
                      className={`w-9 h-9 sm:w-10 sm:h-10 rounded-xl flex items-center justify-center mr-3.5 shrink-0 border transition-transform duration-200 ${
                        isActive
                ...
                >
                  <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-900/10">
                    <div className="flex items-center space-x-3">
                      <div className="w-12 h-12 rounded-2xl bg-navy-950 text-white border border-slate-800 flex items-center justify-center shadow-[0_6px_20px_rgba(0,0,0,0.15)]">
                    ...
                    <span className="text-xs font-bold text-slate-700 bg-white border border-slate-900/15 px-3 py-1 rounded-lg shadow-subtle">
