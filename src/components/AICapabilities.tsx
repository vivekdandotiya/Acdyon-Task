    ...
    <section className="py-20 lg:py-28 bg-navy-950 text-white relative overflow-hidden">
      ...
      <div className="max-w-[1280px] mx-auto px-5 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="text-xs font-bold uppercase tracking-wider text-white bg-slate-900 px-3.5 py-1 rounded-full border border-slate-700 shadow-subtle">
        ...
        {/* 4 Cards Grid with Dark Glassmorphism & Circular Icon Badges */}
            ...
            >
              <div>
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="w-12 h-12 rounded-full bg-slate-900 border border-slate-700 flex items-center justify-center shadow-[0_6px_20px_rgba(0,0,0,0.3)] group-hover:-translate-y-0.5 transition-transform duration-200">
