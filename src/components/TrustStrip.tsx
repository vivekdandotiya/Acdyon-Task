...
export const TrustStrip: React.FC = () => {
  const principles = [
    ...
    { title: 'Executive-Friendly', icon: Shield, desc: 'Tailored for senior decision-makers' },
      ...
      <div className="max-w-[1280px] mx-auto px-5 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="text-center md:text-left max-w-md">
            <p className="text-xs font-bold uppercase tracking-wider text-acdyon-indigoLight mb-1">
              Core Principles
            </p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 w-full md:w-auto">
            {principles.map((item, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="flex items-center space-x-3 p-3 rounded-xl bg-slate-800/60 border border-slate-700/50"
                >
                  <div className="w-8 h-8 rounded-lg bg-acdyon-blue/20 text-acdyon-blueLight flex items-center justify-center shrink-0">
